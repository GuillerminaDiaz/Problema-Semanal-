...
public partial class DbServiciosContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TTurno>().Navigation(e => e.
TDetallesTurnos).AutoInclude();
        modelBuilder.Entity<TDetallesTurno>().Navigation(e => e.IdServicioNavigation).AutoInclude();
